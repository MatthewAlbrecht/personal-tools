		...
		<style
			...
			dangerouslySetInnerHTML={{
				__html: `
					...
					*/
					/* Letter landscape: two 5.5in half-letter panels; base inset + optional outer pad on all sides. */
					@page {
						size: 11in 8.5in;
						margin: 0;
					}
					...
					.zine-cover-has-image.zine-cover-spread-half.zine-cover-full-bleed {
						padding: 0 !important;
					}
