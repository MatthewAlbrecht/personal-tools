...
import { ExternalLink, Loader2, Pause, Play, Sparkles } from "lucide-react";
import { useEffect, useState } from "react";
import { Button } from "~/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "~/components/ui/card";
import { Label } from "~/components/ui/label";
import { Textarea } from "~/components/ui/textarea";
import type { PlayerState, ReviewState, SpotifyTrack } from "../_utils/types";
...
export function SongReviewCard({
	...
	const isPlayButtonLoading =
		playerState?.isPending && playerState?.pendingTrackId === track.id;
						...
						<div className="flex items-start justify-between gap-2">
							...
							{onTogglePlayback && (
								<button
									...
									className="flex-shrink-0 rounded p-1 hover:bg-primary/10 disabled:opacity-50"
