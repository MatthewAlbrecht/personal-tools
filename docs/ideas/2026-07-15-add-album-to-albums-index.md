...
- Done — shipped on `feat/albums-add-and-rym-speed`: Add album dialog on `/albums/all` + `addAlbumToLibrary` mutation. Spec: `docs/superpowers/specs/2026-07-16-add-album-to-albums-index-design.md`, plan: `docs/superpowers/plans/2026-07-16-add-album-to-albums-index.md`
