---
title: Refactor smart playlist fields
...
we need to fix how the smart playlist fields work, theres lots to modify, so not gonna list them but we need a good refactor
